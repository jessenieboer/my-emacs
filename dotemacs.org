...
(:color amaranth :quit-key ("<f19>") :title "emacs")
    ("emacs nav"
     ...
     (("hj" revert-buffer "revert buffer")
      ...
      ("ug" (persp-kill-buffer (current-buffer)) "delete this buffer")
      ("u[" persp-kill-buffer "delete a buffer")
      ("ua" (persp-add-buffer (current-buffer)) "add this buffer")
      ("u=" persp-add-buffer "add a buffer")
      ("ud" (persp-remove-buffer (current-buffer)) "remove this buffer")
      ("u<" persp-remove-buffer "remove a buffer")
      ("ur" persp-kill "delete purse")
      ("ut" persp-copy "delete purse")
      ("u RET" persp-rename "rename purse")
      ("ul" (persp-save-state-to-file persp-state-default-file) "save purse")
      ("uf" (persp-load-state-from-file persp-state-default-file) "load purse")
      ("u/" (persp-save-state-to-file persp-state-backup-file) "save backup purse")
      ("u$" (persp-load-state-from-file persp-state-backup-file) "load backup purse"))))
  #+end_src
*** magit
#+begin_src emacs-lisp
