  ...
  (major-mode-hydra-define (calendar-mode conf-unix-mode conf-windows-mode dired-mode emacs-lisp-mode fundamental-mode help-mode lisp-interaction-mode magit-repolist-mode magit-revision-mode magit-log-mode magit-process-mode magit-stash-mode magit-section-mode magit-diff-mode magit-log-select-mode magit-submodule-list-mode magit-refs-mode magit-stashes-mode magit-merge-preview-mode magit-reflog-mode magit-cherry-mode magit-status-mode nix-mode org-mode org-agenda-mode package-menu-mode sh-mode sql-interactive-mode sql-mode sqlplus-mode text-mode)
    ...
    ("emacs nav"
     (("|" (other-window -1) "pree win")
      ...
      ("?" next-buffer "nex buff")
      ("h SPC" persp-counsel-switch-buffer "go buff")
      ("h (" counsel-switch-buffer "go buff all ")
     ...
     (("hj" revert-buffer "revert buff")
      ...
      ("hg" (kill-buffer nil) "delete buff")
      ("h[" kill-buffer "hard delete buff list")
      ...
      ("ud" (persp-add-buffer (current-buffer))"add buff")
      ("ug" (persp-remove-buffer (current-buffer)) "remove buff")
      ("ua" (persp-set-buffer (current-buffer)) "ex buff")
      ("u[" persp-kill "delete purse")
      ("u RET" persp-rename "rename purse")
      ("ul" (persp-state-save persp-state-default-file) "save purse")
      ("uf" (persp-state-load persp-state-default-file) "load purse")
      ("u/" (persp-state-save persp-state-backup-file) "save backup purse")
      ("u$" (persp-state-load persp-state-backup-file) "load backup purse"))))
  #+end_src
*** magit
#+begin_src emacs-lisp
