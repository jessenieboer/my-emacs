...
*** text/code
#+begin_src emacs-lisp
(major-mode-hydra-define+ (conf-unix-mode conf-windows-mode emacs-lisp-mode fundamental-mode text-mode org-mode sh-mode)
