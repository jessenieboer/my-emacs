  ...
  #+begin_src emacs-lisp
		...
		("emacs nav"
		 (("y" other-window "nex win")
		  ...
		  ("h SPC" persp-switch-to-buffer "go buffer")
		  ("h (" persp-switch "go purse")
		  ("j" ivy-resume "mini resume"))

		 "emacs view"
		 (("dn" split-window-right "make win")
		  ("dh" split-window-below "make win down")
		  ("dc" make-frame-command "make frame")
		  ("d;" delete-window "delete win")
		  ("d>" delete-other-windows "delete oth win")
		  ("d," delete-frame "delete frame")
		  ("dp" fit-window-to-buffer "fit win")
		  ("d]" balance-windows "balance win")
		  ("db" maximize-window "max win")
		  ("dk" toggle-frame-fullscreen "full frame")
		  ("de" (recenter nil) "recenter")
		  ("di" (recenter 0) "recenter top")
		  ("do" (recenter -1) "recenter bot")
		 ...
		 (("hj" revert-buffer "revert buff")
		  ...
		  ("h DEL" counsel-M-x "command")
		  ("hd" magit-status "magit")
		  ...
		  ("hta" persp-add-buffer "purse add")
		  ("htg" persp-remove-buffer "purse remove")
		  ("ht DEL" persp-set-buffer "purse add ex")
		  ("htj" persp-kill "purse delete")
		  ("htr" persp-rename "purse rename")
		  ("htl" persp-save-state-to-file "purse save")
		  ("htd" persp-load-state-from-file "purse load"))))
  #+end_src
*** minibuffer
#+begin_src emacs-lisp
...
(major-mode-hydra-define+ (magit-repolist-mode magit-revision-mode magit-log-mode magit-process-mode magit-stash-mode magit-section-mode magit-diff-mode magit-log-select-mode magit-submodule-list-mode magit-refs-mode magit-stashes-mode magit-merge-preview-mode magit-reflog-mode magit-cherry-mode magit-status-mode)
  ...
  (
   ...
   (("i SPC" magit-stage "git stage")
    ...
    ("ij" magit-merge "git merge" :exit t)
